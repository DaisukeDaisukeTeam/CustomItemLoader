...
class CustomFoodItem extends Food{
	...
	public function __construct(ItemIdentifier $identifier, string $name = "Unknown", int $maxStackSize = 64, int $nutrition = 1, bool $canAlwaysEat = false, float $saturation = 1, ?Item $residue = null){
